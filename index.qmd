...
Nine cumulative labs, beginning with Lab 0, teach R programming and the statistical foundations of survey analysis. Topics include data structures and wrangling, descriptive statistics, visualization, probability, sampling distributions, confidence intervals, hypothesis tests, measurement and scales, survey weights, regression, predicted probabilities, and reproducible reporting. Every topic is connected to a survey-research decision or application.

### Individual methods memos

Short memos require students to make and defend methodological decisions. These assignments ensure that each student develops independent expertise even when much of the semester's work is collaborative.

### Univision project milestones

Teams will complete defined products such as a research-objectives memo, question module, cognitive-testing report, sampling and mode assessment, instrument quality-assurance review, and analysis plan.

### Coauthored report

The class will produce a substantive report using data from the poll. The report will be designed for a public and policy audience and, subject to partner approval, carry LBJ and partner branding.
