...
download.file("https://github.com/GarciaRios/LBJ_SDA/raw/main/Labs/lab_ci/lab_ci.Rmd", destfile = "lab_ci.Rmd")
```
</div>
...
```{r}
load(url("https://github.com/GarciaRios//LBJ_SDA/raw/main/Labs/lab_ci/data/ames.RData"))
