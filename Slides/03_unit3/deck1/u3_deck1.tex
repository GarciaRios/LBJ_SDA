...
Imagine we surveyed all 146 students of our first undergrad LBJ 111 and asked them, among other things, about their social media activity. For instance, we asked how many social media accounts they had.  \pause
...
\begin{frame}[fragile]
\frametitle{Average number of Longhorn games attended}

Next let's look at the population data for the number of UT basketball games attended:
...
\begin{frame}[fragile]
\frametitle{Average number of UT games attended (cont.)}
\small{
...
\clicker{The mean of the sampling distribution is 5.75, and the standard deviation of the sampling distribution (also called the \hl{standard error}) is 0.75. Which of the following is the most reasonable guess for the 95\% confidence interval for the true average number of UT games attended by students?}
