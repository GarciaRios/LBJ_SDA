...
Final teams will depend on enrollment and partner needs. Likely functions include:

- questionnaire and measurement;
- cognitive testing and bilingual review;
- sampling, fieldwork, and quality assurance;
- data management and weighting;
- substantive analysis sections;
- visualization and report production; and
- presentation and partner briefing.

Roles may rotate. Specialization does not excuse students from understanding the full design.
